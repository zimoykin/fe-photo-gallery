        ...
        <nav
            ...
            <div className='nav-bar-command-panel '>
                ...
                <div className='w-50 flex align-left-center'>
                    <i className="nav-bar-icon fas fa-home"
                        onClick={() => navigate('/home')}
                    />
                    <i className="nav-bar-icon fa-solid fa-bell"
                        onClick={() => toast.info('This feature is not implemented yet! 😵‍💫', { toastId: 'notification' })} />
                ...
                <div className='nav-bar-command-panel '>
                    ...
                    {isAuthenticated && <i className="nav-bar-icon fas fa-user"
                    ...
                    />
                        :
                        !isAuthenticated &&
                        <i className="nav-bar-icon fas fa-key"
