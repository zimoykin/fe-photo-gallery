...
const UploadImages: React.FC = () => {
  ...
  const updateFolderInStore = () => {
    if (folder) {
      ...
      dispatch(appendFolders(updatedFolder));
    ...
    <div className="w-100 h-100 flex-column">
      <div className="w-100 h-100">
        <div className="w-100 upload-header-container scroll">
          <div
            className="upload-header-blurred-image"
            style={{
          ...
          <div className="upload-header-content-overlay flex-row w-100 shadow p-10">
            <div className="flex w-70 align-left flex-column">
              ...
              {editMode ? (
                ...
                <span className="pt-10 radius-5">{folder?.description}</span>
              )}
              ...
              <div className="flex-row gap">
                {editMode ? (
                  ...
                  <span className="radius-5">{folder?.color}</span>
                )}
                ...
                {editMode ? (
                  ...
                  <span className="radius-5">{folder?.bgColor}</span>
                )}
              </div>
            </div>
            <div className="align-right w-30 p-10 h-100">
              {!editMode && (
                <div className="palitra-4">
                  <i
                    className="scale-s p-10 hover-bg fas fa-pen"
              ...
              {editMode && (
                <div>
                  <i
                    className="pointer scale-l palitra-4 p-10 hover-bg  fas fa-save"
                    onClick={handleSaveFolderData}
                  />
                  <i
                    className="pointer scale-l p-10 fas palitra-1 fa-close"
