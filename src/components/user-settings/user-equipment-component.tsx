...
const UserEquipment: React.FC<Props> = ({
  equipment,
  addStar,
  deleteEquipment,
  editMode,
      ...
      <div className="table">
        <div className="table-line shadow scale-s">
          <div className="flex-center align-left p-10 w-70">
            {editMode ? (
              <input
                className="p-3 palitra-4 w-80 radius-5"
                type="text"
          ...
          <div className="flex-center align-left p-10 w-70">
            {editMode ? (
              <select
                className="p-3 palitra-4 w-80 radius-5 w-100"
                name="type"
                id="type"
          ...
          <div className="flex-cente align-right p-10 w-30">
            <i
              className="scale-l hover-bg p-2  fas fa-star"
              onClick={addStar}
              style={equipment.favorite ? { color: 'yellow' } : {}}
            />
            <i className="scale-l hover-bg p-2  fas fa-trash" onClick={deleteEquipment} />
          </div>
        </div>
      </div>
    </div>
